...
namespace LanguageCenter.Areas
{
    public class HomeAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("", "danh-sach-giao-vien", defaults: new { controller = "Teacher", action = "GetPage_Teacheres", area = "Home" });
            ...
            #region học sinh đăng ký lớp học
            context.MapRoute("", "danh-sach-hoc-sinh-dang-ky-theo-lop/{classID}", defaults: new { controller = "Class", action = "GetPage_RegistrationClassByClassID", area = "Home", classID = UrlParameter.Optional });
            context.MapRoute("", "dang-ky-hoc-sinh-theo-lop/{studentId}/{classId}", defaults: new { controller = "Class", action = "StudentRegistrationClass", area = "Home", studentId = UrlParameter.Optional, classId = UrlParameter.Optional });
            #endregion
